...
#ifndef _GDT3_H_INCLUDED
#define _GDT3_H_INCLUDED
...
public:
  ...
  static void copy(unsigned int addr, const uint8_t *src, int count);
  ...
  static void microcode(const uint8_t *src, int count);
  static void uncompress(unsigned int addr, const uint8_t *src);
